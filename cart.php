...
<body>
    <div class="container">
        <?php include('page/header.php') ?>
            ...
            <input type="text" name="amount" id="amount_<?php echo $item['product_id']; ?>" value="<?php echo $item['quantity']; ?>">
            <!-- Nút tăng số lượng -->
    ...
    function handleMinus(productId) {
        ...
        if (amount > 1) {
            ...
            updateCart(productId, amount);
                                    ...
                                    <td><a href="remove_from_cart.php?product_id=<?php echo $item['product_id']; ?>">XÓA</a></td>
                                </tr>
                                <?php
                            }
                        } else {
